...
def _load_local_tiktoken_bpe(path: Path) -> dict[bytes, int]:
    ret = {}
...
def o200k_base():
    local_data = Path(__file__).with_name("data") / "o200k_base.tiktoken"
    mergeable_ranks = _load_local_tiktoken_bpe(local_data)
